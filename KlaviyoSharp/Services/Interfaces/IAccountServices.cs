...
public interface IAccountServices
{
    ...
    /// </summary>
    /// <param name="accountFields">For more information please visit <see href="https://developers.klaviyo.com/en/reference/api-overview#sparse-fieldsets">Fieldsets overview</see></param>
